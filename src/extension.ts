...
import { ConfigAction, configureFunction } from './functions/function-command/configure-function';
...
export async function activate(extensionContext: vscode.ExtensionContext): Promise<void> {
  ...
  disposable = [
    ...
    vscode.commands.registerCommand('function.addConfig', (context) => configureFunction(ConfigAction.Add, context)),
    vscode.commands.registerCommand('function.addConfig.Palette', () => configureFunction(ConfigAction.Add)),
    vscode.commands.registerCommand('function.removeConfig', (context) => configureFunction(ConfigAction.Remove, context)),
