...
export class KnativeExplorer implements TreeDataProvider<KnativeTreeObject>, Disposable {
    ...
    private onDidChangeTreeDataEmitter: EventEmitter<KnativeTreeObject | undefined> = new EventEmitter<KnativeTreeObject | undefined>();
    readonly onDidChangeTreeData: Event<KnativeTreeObject | undefined> = this.onDidChangeTreeDataEmitter.event;
    ...
    private constructor() {
        ...
        KnativeExplorer.knctl.subject.subscribe(event => event.reveal ? this.reveal(event.data) : this.refresh(event.data));
    }
