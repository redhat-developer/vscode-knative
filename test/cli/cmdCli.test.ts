...
import { CmdCli, cliCommandToString, createCliCommand, CliCommand } from '../../src/cli/cmdCli';
...
suite('', () => {
  ...
  // test('should execute the command and return data from running it', async () => {
  ...
  //   assert.equals(result, { error: undefined, stdout: 'test data' });
  // });
});
